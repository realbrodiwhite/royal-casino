...
export default function IdVerificationPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // In a real app, you would get a response from your backend
      // and then decide if verification was successful.
      toast({
      ...
      // Mark user as "pending verification" or "verified" in your backend.
      // For this prototype, we'll assume successful submission and redirect.
      router.push('/lobby');
    }, 2000);
  };
              ...
              {previewUrl && selectedFile && (
                <div className="mt-4 border border-dashed border-border p-3 rounded-md">
                  ...
                  <Image
                    ...
                    onLoad={() => URL.revokeObjectURL(previewUrl)} // Clean up object URL after image loads
                  />
