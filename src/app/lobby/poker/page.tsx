...
// src/app/lobby/poker/page.tsx
"use client";

import Navbar from '@/components/layout/navbar';
import { Button } from '@/components/ui/button';
import Link from 'next/link';
import { Rows } from 'lucide-react'; // Placeholder icon
  ...
  return (
    <div className="min-h-screen bg-deep-purple text-silver flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-16 flex flex-col items-center justify-center text-center">
        <Rows className="h-24 w-24 text-gold mb-6" />
        <h1 className="text-5xl font-bold font-headline text-gold mb-4">Poker Room</h1>
        <p className="text-xl text-silver mb-8">
          Our Poker tables are currently under construction. Check back soon!
        </p>
        <Link href="/lobby">
